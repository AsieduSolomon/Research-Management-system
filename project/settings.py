...
# Security - Use environment variable or a fixed key for testing
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', 'django-insecure-your-secret-key-here-change-in-production')

# For academic project, you can keep DEBUG=True to see errors
...
# Jazzmin Configuration (keep as is)
JAZZMIN_SETTINGS = {
...
# SQLite database will be created during deployment
DATABASES = {
    'default': {
...
# Channels - Use in-memory for demo
CHANNEL_LAYERS = {
    'default': {
...
# Media files - For demo, store in filesystem
# Note: These will be lost on redeployment but work for demonstration
MEDIA_URL = '/media/'
